...
Create a function named `qq_norm` taking a vector of sample data 
as an argument and returning the slope and intercept of the line for 
a Q-Q plot in a list.
...
Use the `qq_norm` function to compute the 
...
Generalise function from Exercise 1 to create function to compute 
slope and intercept for a Q-Q plot based on any theoretical distribution.
...
Check the new function works as expected for the t distribution.
